document.addEventListener('DOMContentLoaded', () => {
    ...
    function approveCourse(actionIndex) {
        ...
        Toastify({ text: "Course approved.", duration: 3000, backgroundColor: "linear-gradient(to right, #00b09b, #96c93d)" }).showToast();
    ...
    function declineCourse(actionIndex) {
        ...
        Toastify({ text: "Course declined.", duration: 3000, backgroundColor: "linear-gradient(to right, #dc3545, #ef5350)" }).showToast();
        renderPendingCourses();
    }
